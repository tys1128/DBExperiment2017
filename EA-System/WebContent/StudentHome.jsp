		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="example-navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="button">
						<a href="iframe/student/Chooselesson.jsp" target="left-frame"> 网上选课 </a>
					</li>
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">
							查询信息 <b class="caret"></b>
						</a>
						<ul class="dropdown-menu">
							<li>
								<a href="iframe/student/xskb.jsp" target="left-frame">学生个人课表</a>
							</li>
							<li>
								<a href="iframe/student/xscj.jsp" target="left-frame">学生成绩</a>
							</li>

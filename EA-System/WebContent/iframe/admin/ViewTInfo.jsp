		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form id="formSearch" class="form-horizontal">
					<div class="form-group" style="margin-top: 15px" action=""
						method="post">
						<label class="control-label col-sm-1"
							for="txt_search_departmentname">教师id</label>
						<div class="col-sm-3">
			...
			<table class="table table-bordered">
				...
				<tbody id="tb">
					<%
						...
						List<Teacher> tList = aDAO.getTeacher();
						//生成行
						for (Teacher t : tList) {
					%>
					<tr>
